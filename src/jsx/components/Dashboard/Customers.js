		...
		<>
			...
			<div className="row mb-5 align-items-center">
				<div className="col-lg-3 mb-4 mb-lg-0">
					<Link to={"#"} className="btn btn-primary light  btn-lg btn-block rounded " onClick={()=> setAddItem(true)}> +New Customer</Link>
				</div>
						...
						<div className="card-body py-3 py-md-2">
							<div className="row align-items-center">
								...
								<div className="col-md-7 text-md-right">
									...
									<Link to={"#"} className="btn btn-secondary rounded ml-2 btn-sm px-4">Edit</Link>
									<Link to={"#"} className="btn btn-danger rounded ml-2 btn-sm px-4">Delete</Link>
								</div>
							</div>							
						</div>
					</div>
