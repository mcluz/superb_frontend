								...
								<div className="card-body pb-0">
									<div className="d-flex align-items-center">
										<div className="mr-auto">
											...
											<span className="text-white fs-20 font-w100">Than last day</span>
										</div>
										<span className="fs-40 text-white font-w600 mr-2">94%</span>
							...
							<div className="card">
								<div className="card-body row d-sm-flex d-block align-items-center">
									<div className="media col-sm-5 mb-2 mb-sm-0  align-items-center">
										<svg className="mr-4 min-w50" width="50" height="53" viewBox="0 0 50 53" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div className="media-body">
											<p className="text-white mb-2 font-w300">Income</p>
											<span className="fs-26 text-white">$126,000</span>
										</div>
									</div>
							...
							<div className="card">
								<div className="card-body row d-sm-flex d-block align-items-center">
									<div className="media col-sm-5 align-items-center mb-2 mb-sm-0">
										<svg className="mr-4 min-w50" width="50" height="31" viewBox="0 0 52 31" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div className="media-body">
											<p className="text-white mb-2 font-w300">Customer</p>
											<span className="fs-26 text-white">109,511</span>
										</div>
									</div>
									<div className="col-sm-7">
										<p className="fs-12 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis 
							...
							<div className="card">
								<div className="card-body row d-sm-flex d-block align-items-center">
									<div className="media col-sm-5 align-items-center mb-2 mb-sm-0">
										...
										<div className="media-body">
											<p className="text-white mb-2 font-w300">Last than Year</p>
											<span className="fs-26 text-white">59%</span>
											<svg className="ml-2" width="30" height="15" viewBox="0 0 30 15" fill="none" xmlns="http://www.w3.org/2000/svg">
