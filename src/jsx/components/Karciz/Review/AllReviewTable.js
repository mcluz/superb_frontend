					...
					>
						<div className="checkbox mr-0 align-self-center">
							<div className="custom-control custom-checkbox ">
								<input type="checkbox" onClick={() => chackboxFun("all")} className="custom-control-input" id="checkAll" required=""/>
				...
				<tr role="row" className="odd">
					...
					<td>
						<div className="media align-items-center">
							<img className="img-fluid rounded mr-3 d-none d-xl-inline-block" width="70" src={image01} alt="DexignZone"/>
